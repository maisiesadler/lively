...
namespace Lively.Diagrams.Tests
{
    public class YumlMdTests
    {
        ...
        public void CanCreateDiagramForSimpleDependency()
        {
            ...
            var fullTypeName = "Lively.Diagrams.Tests.YumlMdTests+ExampleTypeWithDeps";
        ...
        public void CanCreateDiagramForDependencyWithImplementation()
        {
            ...
            var config = new DependencyTreeConfig(assembly)
            {
                StartupName = "Lively.Diagrams.Tests.YumlMdTests+Startup",
            };
            var fullTypeName = "Lively.Diagrams.Tests.YumlMdTests+ExampleTypeWithInterfaceDeps";
